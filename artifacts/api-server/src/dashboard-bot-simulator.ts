...
export function renderDashboardBotSimulator(): string {
  ...
  return String.raw`
<style>
#simulatorShell{display:none}.sim-toolbar{display:grid;grid-template-columns:minmax(0,1fr) 180px 220px auto;gap:8px;margin-bottom:12px}.sim-grid{display:grid;grid-template-columns:1.2fr .8fr;gap:12px}.sim-panel{background:linear-gradient(180deg,color-mix(in srgb,var(--panel) 96%,transparent),color-mix(in srgb,var(--panel-2) 96%,transparent));border:1px solid var(--line);border-radius:14px;padding:16px;box-shadow:var(--shadow)}.sim-label{color:var(--muted);font-size:11px;text-transform:uppercase;letter-spacing:.08em}.sim-textarea{width:100%;min-height:190px;resize:vertical;border:1px solid var(--line);background:var(--panel-3);color:var(--text);padding:12px;border-radius:10px;outline:none;font:inherit}.sim-textarea:focus,.sim-input:focus,.sim-select:focus{border-color:var(--line-strong)}.sim-input,.sim-select{width:100%;border:1px solid var(--line);background:var(--panel-3);color:var(--text);padding:10px 11px;border-radius:9px;outline:none}.sim-controls{display:grid;gap:9px}.sim-check{display:flex;align-items:center;gap:8px;color:var(--muted);font-size:12px}.sim-actions{display:flex;gap:8px;flex-wrap:wrap;margin-top:10px}.sim-result{min-height:190px;white-space:pre-wrap;overflow:auto;border:1px solid var(--line);border-radius:10px;background:var(--panel-3);padding:13px}.sim-meta{display:grid;grid-template-columns:repeat(3,minmax(0,1fr));gap:8px;margin-top:10px}.sim-card{border:1px solid var(--line);border-radius:10px;background:var(--panel);padding:10px}.sim-card strong{display:block;margin-bottom:3px}.sim-card span{font-size:12px;color:var(--muted)}.sim-trace{display:grid;grid-template-columns:1fr 1fr;gap:9px}.sim-kv{padding:10px;border:1px solid var(--line);border-radius:10px;background:var(--panel)}.sim-kv b{display:block;font-size:11px;color:var(--muted);text-transform:uppercase;letter-spacing:.06em;margin-bottom:4px}.sim-run-list{display:grid;gap:8px;max-height:430px;overflow:auto}.sim-run{border:1px solid var(--line);border-radius:10px;background:var(--panel);padding:10px;cursor:pointer}.sim-run:hover{border-color:var(--line-strong)}.sim-run-head{display:flex;justify-content:space-between;gap:8px}.sim-run-msg{margin-top:5px;color:var(--muted);font-size:12px;overflow:hidden;text-overflow:ellipsis;white-space:nowrap}.sim-tabs{display:flex;gap:6px;margin-bottom:9px}.sim-tab{border:1px solid var(--line);background:var(--panel);color:var(--muted);padding:7px 9px;border-radius:8px;cursor:pointer}.sim-tab.active{color:var(--text);border-color:var(--line-strong);background:var(--nav-active)}@media(max-width:980px){.sim-toolbar,.sim-grid,.sim-trace{grid-template-columns:1fr}.sim-meta{grid-template-columns:1fr 1fr}}@media(max-width:760px){.sim-meta{grid-template-columns:1fr}}
</style>
<section class="view" id="view-simulator">
  ...
  <div class="sim-toolbar">
    ...
    <label class="sim-check" style="padding:0 9px;border:1px solid var(--line);border-radius:9px;background:var(--panel-3)"><input id="simHistory" type="checkbox" checked /> Include persisted conversation history</label>
